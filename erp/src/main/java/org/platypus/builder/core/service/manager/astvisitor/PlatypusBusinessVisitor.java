 ...
 * on 22/04/17.
 */
public class PlatypusBusinessVisitor extends VoidVisitorAdapter<Void> {
    BusinessMethodModel model = new BusinessMethodModel();

    public static BusinessMethodModel getField(FieldDeclaration fieldDeclaration) {
        PlatypusBusinessVisitor v = new PlatypusBusinessVisitor();
