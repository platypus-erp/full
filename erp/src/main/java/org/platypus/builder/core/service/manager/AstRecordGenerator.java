...
import org.platypus.builder.core.service.manager.astvisitor.BusinessMethodModel;
...
public class AstRecordGenerator {
    ...
    void generateRootRecord(AstService merged, AstRecordRegistry recordRegistry) {
    ...
    private void generateRelationFieldRecord(
            AstService merged, InterfaceBuilder recordBuilder, AstRecordRegistry recordRegistry
    ) {
...
//                b -> b.getReadonly() != Bool.TRUE);
    ...
    private void addRecordRelationMethod(
            Collection<BusinessMethodModel> fields,
            InterfaceBuilder recordBuilder,
            Function<String, MetaInfoRecord> recordRegistry,
            Predicate<BusinessMethodModel> addSetter
    ) {
    ...
    private ClassName toClassName(Function<String, MetaInfoRecord> recordRegistry, BusinessMethodModel targetable) {
    ...
    private void generateBasicFieldRecord(AstService merged, InterfaceBuilder recordBuilder) {
...
//        addRecordMethod(merged.getTimeField(), recordBuilder, b -> b.getReadonly() != Bool.TRUE);
    ...
    private void addRecordMethod(
            Collection<BusinessMethodModel> fields, InterfaceBuilder recordBuilder, Predicate<BusinessMethodModel> addSetter) {
        fields.forEach(b -> recordBuilder.addOnlyReturnMethod(
