...
import org.platypus.builder.core.views.list.generator.MainGenerator;
...
//                .filter(schemaValidator::validateFile)
        ...
        MainGenerator f = new MainGenerator();
        listViews.forEach(f::generate);
