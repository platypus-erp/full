...
public interface DateField extends GenericField<LocalDate> {
    ...
    default QueryPredicate<DateField> isNull() {
        return new PredicateImpl<>(this, DomainPredicate.IS_NULL, empty());
    }

    default QueryPredicate<DateField> isNotNull() {
        return new PredicateImpl<>(this, DomainPredicate.IS_NOT_NULL, empty());
    }

    default QueryPredicate<DateField> less(LocalDate than) {
        return new PredicateImpl<>(this, DomainPredicate.IS_NOT_NULL, of(than));
    }

    default QueryPredicate<DateField> less(DateField than) {
        return new PredicateImpl<>(this, DomainPredicate.IS_NOT_NULL, than);
    }
