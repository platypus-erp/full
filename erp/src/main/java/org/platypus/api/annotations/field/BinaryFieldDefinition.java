...
public @interface BinaryFieldDefinition {
    ...
    /**
     * (Optional) <br> Only if you want to erase all the definition of this aggregate defined in other module
     */
    ...
    /**
     * (Optional) <br> Define if this aggregate is load lazily or not
     */
