...
public class RestTest {
    ...
    public List<String> myBusinessMethod(List<String> record, String tt) {
        BaseUserService.MyBusinessMethod.Super root = (p1, p2) -> this.inherit0.myBusinessMethod(p1, p2);
        BaseUserService.MyBusinessMethod.Super inherit1M = (p1, p2) -> this.inherit1.myBusinessMethod(p1, p2, root);
        BaseUserService.MyBusinessMethod.Super inherit2M = (p1, p2) -> this.inherit2.myBusinessMethod(p1, p2, inherit1M);
