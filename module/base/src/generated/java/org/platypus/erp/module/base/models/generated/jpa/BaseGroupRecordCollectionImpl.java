...
public class BaseGroupRecordCollectionImpl
        extends RecordCollectionImpl<BaseGroupRecord, ImplGroupJPA, BaseGroupRecordCollection>
        implements BaseGroupRecordCollection {
  public BaseGroupRecordCollectionImpl(String name, Supplier<QueryPath> getPath,
    ...
    super(ImplGroupJPA.MODEL_NAME, name, getPath, getter, setter);
  }
