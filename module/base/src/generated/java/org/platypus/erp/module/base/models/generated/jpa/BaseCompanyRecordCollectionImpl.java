...
public class BaseCompanyRecordCollectionImpl
        extends RecordCollectionImpl<BaseCompanyRecord, ImplCompanyJPA, BaseCompanyRecordCollection>
        implements BaseCompanyRecordCollection {
    public BaseCompanyRecordCollectionImpl(String name, Supplier<QueryPath> getPath,
        ...
        super(ImplCompanyJPA.MODEL_NAME, name, getPath, getter, setter);
    }
