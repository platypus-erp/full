...
following org.platypus.api.fields:
...
Example using all org.platypus.api.fields (required org.platypus.api.fields are noted):
...
Each option spec in the `options` array must/can have the following org.platypus.api.fields:
