...
import org.platypus.framework.maven.views.list.column.boolcol.ListViewBooleanColumn;
import org.platypus.framework.maven.views.list.column.currencycol.ListViewCurrencyColumn;
import org.platypus.framework.maven.views.list.column.datecol.ListViewDateColumn;
import org.platypus.framework.maven.views.list.column.datetimecol.ListViewDateTimeColumn;
import org.platypus.framework.maven.views.list.column.floatcol.ListViewFloatColumn;
import org.platypus.framework.maven.views.list.column.imgcol.ListViewImgColumn;
import org.platypus.framework.maven.views.list.column.integercol.ListViewIntegerColumn;
import org.platypus.framework.maven.views.list.column.linkcol.ListViewLinkColumn;
import org.platypus.framework.maven.views.list.column.relation.ListViewRelationColumn;
import org.platypus.framework.maven.views.list.column.stringcol.ListViewStringColumn;
import org.platypus.framework.maven.views.list.column.timecol.ListViewTimeColumn;
